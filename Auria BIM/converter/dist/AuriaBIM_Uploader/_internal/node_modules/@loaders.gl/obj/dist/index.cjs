...
function getFieldFromAttribute(name, attribute) {
  ...
  let { type } = (0, import_schema_utils.getDataTypeFromArray)(attribute.value);
...
function parseOBJ(text, options) {
  ...
  const header = {
    ...
    boundingBox: (0, import_schema_utils2.getMeshBoundingBox)(attributes)
  };
