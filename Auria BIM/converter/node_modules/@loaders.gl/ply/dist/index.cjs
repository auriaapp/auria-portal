...
__export(dist_exports, {
  PLYArrowLoader: () => PLYArrowLoader,
  PLYFormat: () => PLYFormat,
  PLYLoader: () => PLYLoader,
  PLYWorkerLoader: () => PLYWorkerLoader
});
...
function getPLYSchema(plyHeader, attributes) {
  ...
  const schema = (0, import_schema_utils.deduceMeshSchema)(attributes, metadata);
  return schema;
}
